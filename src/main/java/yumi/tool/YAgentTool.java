...
public class YAgentTool {
     ...
     * @see YAgentTool#create(ReactAgent, String )
     */
    public static ToolCallback getFunctionToolCallback(ReactAgent agent, String inputSchema) {
        return YAgentTool.create(agent, inputSchema);
    }
     ...
     * @return ToolCallback created with MethodToolCallback
     */
    public static ToolCallback create(ReactAgent agent, String inputSchema) {
        ...
        String originalSchema = inputSchema;
