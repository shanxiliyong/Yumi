...
public abstract class AbstractJdbcCheckpointSaver implements BaseCheckpointSaver, LatestCheckpointCacheConfigurable {
    ...
    public final RunnableConfig put(RunnableConfig config, Checkpoint checkpoint) throws Exception {
        ...
        try {
            ...
            insertMysqlCheckpoint(threadId, checkpoint, config);
            deleteRetainedCheckpoints(threadId, config);
            if (latestCheckpointCacheEnabled) {
    ...
    /**
     * Inserts a new active checkpoint for a thread with the given config.
     *
     * @param threadId
     * @param checkpoint
     * @param config
     * @throws Exception
     */
    public void insertMysqlCheckpoint(String threadId, Checkpoint checkpoint, RunnableConfig config) throws Exception {
