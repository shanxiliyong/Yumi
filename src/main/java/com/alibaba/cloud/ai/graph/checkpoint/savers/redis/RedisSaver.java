...
public class RedisSaver implements BaseCheckpointSaver {
    ...
    public RunnableConfig put(RunnableConfig config, Checkpoint checkpoint) throws Exception {
        ...
        try {
            ...
            RBucket<String> bucket_json = redisson.getBucket(CHECKPOINT_PREFIX+"_json_"+ threadId);
            String jsonStr = JackJsonUtil.toJsonStr(checkpoint);
            log.info("put json: {}",jsonStr);
            bucket_json.set(jsonStr);
